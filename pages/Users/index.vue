<template>
  <UContainer :ui="{ base: 'pt-10 pb-20' }">
    ...
    <UCard>
      <template #header>
        <div
          class="flex w-full flex-col-reverse md:flex-row justify-between gap-y-3 md:gap-y-0"
        >
...
useSeoMeta({
  title: "Users | Tapwal",
  ogTitle: "Users",
  description: "Users page where you can manage all the users.",
  ogDescription: "Users page where you can manage all the users.",
});
